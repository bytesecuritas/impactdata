...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'timestamp'], name='core_userac_user_id_9ccfb2_idx'),
        ),
        migrations.AddIndex(
            model_name='useractionlog',
            index=models.Index(fields=['action', 'timestamp'], name='core_userac_action_c8e369_idx'),
        ),
    ]
